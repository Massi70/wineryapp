	...
	$('.error').hide();
		...
		if(latitude==''){
			...
			return false;
       		...
       		$('.error').html('Only Numbers For Latitude');
			$('.error').show();
			return false;
    	}
		if(longitude==''){
			...
			return false;
       		...
       		$('.error').html('Only Numbers For Longitude');
			$('.error').show();
			return false;
    	}
...
<div class="module" id="module" style="display:block;">
    ...
    <span class="error" style="color:#F00"> </span>
      ...
      <tr>
          ...
          <td><input type="text" name="description" id="description" value="<?php echo $data[0]['description'];?>"   /></td>
      </tr>
      <tr>
