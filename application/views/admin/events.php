        ...
        <table width="100%" height="111" class="tablesorter" id="myTable">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><?php echo $val['timedate']  ; ?></td>
              <td><?php echo $val['flavour']  ; ?></td>
              <td><?php echo $val['entry_fee']  ; ?></td>
              <td>
              	<a href="<?php echo base_url();?>admin/events/view/?id=<?php echo $val['event_id']; ?>" >View Details / </a>
          <!--      <a href="<?php //echo base_url();?>admin/events/delete/?id=<?php //echo $val['event_id']; ?>" > / Delete</a> -->
               	<a href="<?php echo base_url();?>admin/events/delete/?id=<?php echo $val['event_id']; ?>" onclick="return confirm('Are you sure to delete this Event?');">Expire</a><?php ?></td>
            </tr>
            <?php $i++; 
						}
					}else{
