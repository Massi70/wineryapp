...
$(document).ready(function(){
	$('#form1').submit(function(){
		if(trim($(this).find('#key').val())!=''){
			ajax('<?php echo base_url();?>admin/addWine?t=1','main_div','form1','spinner');
			return false;
		}
		return false;
	});
...
$('a[id^="winery_id"]').live("click",function(){
var id = parseInt($(this).attr('id').replace('winery_id',''));
top.location="<?php echo base_url();?>index.php/admin/wineries/addWine?id="+id;
});
</script>
...
-->
  ...
  <!-- Example table -->
   <div style="float:left"><a href="<?php echo base_url();?>admin/wineries/addWine/">Add New Wine </a></div> 
  <div class="module">
          ...
          <tbody>
            ...
            <tr>
             ...
             <td> <!-- <a href="<?php //echo base_url();?>admin/wineries/edit/?id=<?php //echo $val['winery_id']; ?>" >Edit / </a> -->
               <a href="<?php echo base_url();?>admin/wineries/view/?id=<?php echo $val['winery_id']; ?>" > View Details / </a>
              ...
              <!-- <a href="<?php //echo base_url();?>admin/wineries/delete/?id=<?php //echo $val['winery_id']; ?>" onclick="return confirm('Are you sure to delete this Wine?');">Delete</a><?php ?></td> -->
               	<a href="<?php echo base_url();?>admin/events/?id=<?php echo $val['winery_id']; ?>" >View Events </a></td>
