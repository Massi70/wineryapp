...
//include_once(DOC_ROOT."includes/CurlHttpClient.php"); 
...
class Instagram {
    ...
    protected $_endpointUrls = array(
        ...
        'user_feed_count' => 'https://api.instagram.com/v1/users/self/feed?access_token=%s&max_id=%s&min_id=%s&max_timestamp=%s&min_timestamp=%s&count=%s',		
        ...
        'user_recent_count' => 'https://api.instagram.com/v1/users/%s/media/recent/?access_token=%s&max_id=%s&min_id=%s&max_timestamp=%s&min_timestamp=%s&count=%s',
		'user_self_media_liked' => 'https://api.instagram.com/v1/users/self/media/liked?access_token=%s&MAX_LIKE_ID=%s&count=%s',
        ...
        'media_popular_count' => 'https://api.instagram.com/v1/media/popular?access_token=%s&max_id=%s&min_id=%s&max_timestamp=%s&min_timestamp=%s&count=%s',
        ...
        'delete_media_comment' => 'https://api.instagram.com/v1/media/%d/comments/%d?access_token=%s',
    ...
    */
    ...
    protected function _setOauthToken() {
        ...
        $this->_httpClient->setPostParam('scope', implode( '+', $this->_config['scope']));
	...
	//Modified my Abdul Rauf	
    public function getUserFeedWithCount($maxId = '', $minId = '', $maxTimestamp = '', $minTimestamp = '',$count=1) {
	    $endpointUrl = sprintf($this->_endpointUrls['user_feed_count'], $this->getAccessToken(), $maxId, $minId, $maxTimestamp, $minTimestamp,$count);
        $this->_initHttpClient($endpointUrl);
        return $this->_getHttpClientResponse();
    }
	...
	//Modified my Abdul Rauf	
    public function getUserRecentWithCount($id, $maxId = '', $minId = '', $maxTimestamp = '', $minTimestamp = '',$count=1) {
        $endpointUrl = sprintf($this->_endpointUrls['user_recent_count'], $id, $this->getAccessToken(), $maxId, $minId, $maxTimestamp, $minTimestamp,$count);
        $this->_initHttpClient($endpointUrl);
        return $this->_getHttpClientResponse();
    }
	...
	*/
	//Modified my Abdul Rauf	
    public function getUserSelfMediaLikedWithCount($maxId,$count=1) {
        $endpointUrl = sprintf($this->_endpointUrls['user_self_media_liked'], $this->getAccessToken(), $maxId, $count);
        $this->_initHttpClient($endpointUrl);
        return $this->_getHttpClientResponse();
    }
	...
	//Modified my Abdul Rauf
    public function getPopularMediaWithCount($maxId = '', $minId = '', $maxTimestamp = '', $minTimestamp = '',$count=1) {        
		$endpointUrl = sprintf($this->_endpointUrls['media_popular_count'], $this->getAccessToken(), $maxId, $minId, $maxTimestamp, $minTimestamp,$count);
        $this->_initHttpClient($endpointUrl);
        return $this->_getHttpClientResponse();
    }
