...
*/
function authorize($code = 'CODE')
{

$authorization_url = 'https://api.instagram.com/oauth/access_token';
$scope_ary=array('basic','comments','relationships','likes' );
//return $this->__apiCall($authorization_url, "client_id=" . $this->codeigniter_instance->config->item('instagram_client_id') . "&client_secret=" . $this->codeigniter_instance->config->item('instagram_client_secret') . "&grant_type=authorization_code&redirect_uri=" . $this->codeigniter_instance->config->item('instagram_callback_url') . "&response_type=code&scope=".implode( '+', $scope_ary));
$code1 = $this->__apiCall($authorization_url, "client_id=" . $this->codeigniter_instance->config->item('instagram_client_id') . "&client_secret=" . $this->codeigniter_instance->config->item('instagram_client_secret') . "&grant_type=authorization_code&redirect_uri=" . $this->codeigniter_instance->config->item('instagram_callback_url') . "&code=" . $code);
print_r($code1);
exit;
...
*/
	...
	public function getCurrentUser() {
		return $_accessToken = $this->authorize();
