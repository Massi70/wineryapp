...
class Vimeo
{
    ...
    {
        $this->_consumer_key = $params['consumer_key'];
        $this->_consumer_secret = $params['consumer_secret'];

        if (isset($params['token']) && isset($params['token_secret'])) {
            $this->setToken($params['token'], $params['token_secret']);
        }
    }
