...
//        }
    ...
    function my_link_to_remote($url, $text, $div, $pars=array()){
        ...
        $html = "<a href=\"#\"  onclick=\"simpleAjaxPaging('$url','$div','paging_spinner'); return false;\" />$text</a>";
        else:
        $html = "<a href=\"#\"  onclick=\"new Ajax.Updater('$url','$div','paging_spinner'); return false;\" />$text</a>";
        endif;
    return $html;
    }
}
